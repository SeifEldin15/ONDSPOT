...
async function createOGImageFromFavicon() {
    ...
    try {
        // Use favicon.png as the logo
        const logo = await loadImage('./favicon.png');
        console.log(`✓ Loaded favicon: ${logo.width}x${logo.height}`);
        ...
        console.log('\nPlease make sure favicon.png exists in this folder');
    }
}

createOGImageFromFavicon();
