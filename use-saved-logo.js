...
async function createOGImageFromPNG() {
    ...
    try {
        // Load the user's saved PNG
        const logo = await loadImage('./on-logo.png');
        ...
        console.log('\nPlease save the "ON" logo image as "on-logo.png" in this folder first');
    }
}

createOGImageFromPNG();
